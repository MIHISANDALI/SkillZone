...
public class LearningProgressModel {
    ...
    public LearningProgressModel(String id, String postOwnerID, String postOwnerName, String skillTitle, String description, String field, String startDate, String endDate) {
        this.id = id;
